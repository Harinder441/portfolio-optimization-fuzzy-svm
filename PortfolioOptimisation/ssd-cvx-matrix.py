...
df=pd.read_excel(r"C:\Users\Ruchika\Downloads\NFTY50_150days.xlsx").iloc[:5,1:4]
df1=pd.read_excel(r"C:\Users\Ruchika\Downloads\10companies_Nfty.xlsx").iloc[:5,1:2]
