...
df=read_excel(r"C:\Users\admin\Downloads\NIFTY50 2015-Present ALL.xlsx",sheet_name='SVM_FilteredData2015-2022')
#sdf=df.iloc[:523,3:]
sdf=df.iloc[1:1861,3:]
dfReturns=read_excel(r"C:\Users\admin\Downloads\NIFTY50 2015-Present ALL.xlsx",sheet_name='SVM_ReturnsAllFeatures')   #give path of return file here
...
# print(df2)
writein=pd.ExcelWriter("NFTY50_FSVMRolling0to26.xlsx", engine='xlsxwriter')
