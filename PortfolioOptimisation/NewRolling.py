...
dfReturns=read_excel(r"C:\Users\admin\Downloads\S&P 500daily ALL.xlsx",sheet_name='ReturnsAllWithoutIndex')   #give path of return file here
...
# print(df2)
writein=pd.ExcelWriter("S&P500_SVMRolling0to26.xlsx", engine='xlsxwriter')
