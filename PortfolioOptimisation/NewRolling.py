...
df=read_excel(r"C:\Users\admin\Downloads\FTSE100ALL (1).xlsx",sheet_name='FilteredWithoutIndexAll')
#df=read_excel(r"C:\Users\admin\Downloads\S&P 500daily ALL.xlsx",sheet_name='FilteredDataWithoutIndex')
#sdf=df.iloc[:523,3:]
sdf=df.iloc[1470:1814,3:]
...
dfReturns=read_excel(r"C:\Users\admin\Downloads\FTSE100ALL (1).xlsx",sheet_name='ReturnsWithoutIndexAll')   #give path of return file here
#dfReturns=read_excel(r"C:\Users\admin\Downloads\S&P 500daily ALL.xlsx",sheet_name='ReturnsAllWithoutIndex')
sdfReturns=dfReturns.iloc[1470:1814,3:]
#print(sdfReturns)
