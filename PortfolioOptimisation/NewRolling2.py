...
df=read_excel(r"C:\Users\Abha\Downloads\NASDAQ 100 daily.xlsx",sheet_name='FilteredAllWithoutIndex')
#df=read_excel(r"C:\Users\admin\Downloads\S&P 500daily ALL.xlsx",sheet_name='FilteredDataWithoutIndex')
#sdf=df.iloc[:523,3:]
#sdf=df.iloc[1485:1827,3:]
...
dfReturns=read_excel(r"C:\Users\Abha\Downloads\NASDAQ 100 daily.xlsx",sheet_name='ReturnsAllWithoutIndex')   #give path of return file here
#dfReturns=read_excel(r"C:\Users\admin\Downloads\S&P 500daily ALL.xlsx",sheet_name='ReturnsAllWithoutIndex')
#sdfReturns=dfReturns.iloc[1485:1827,3:]
#print(sdfReturns)
...
writein=pd.ExcelWriter("NASDAQ100_FSVMRolling0to27rolling(F).xlsx", engine='xlsxwriter')
#writein=pd.ExcelWriter("NIKKEI400_FSVMRolling0(F).xlsx", engine='xlsxwriter')
