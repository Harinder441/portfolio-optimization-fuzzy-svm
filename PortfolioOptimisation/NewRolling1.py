...
df=read_excel(r"C:\Users\Abha\Downloads\Simran Data\TA 35 Israel.xlsx",sheet_name='FilterAllWithoutIndex')
...
dfReturns=read_excel(r"C:\Users\Abha\Downloads\Simran Data\TA 35 Israel.xlsx",sheet_name='ReturnsAllWithoutIndex')   #give path of return file here
...
writein=pd.ExcelWriter("TA35_SVMRolling0(F).xlsx", engine='xlsxwriter')
#writein=pd.ExcelWriter("NIKKEI400_FSVMRolling0(F).xlsx", engine='xlsxwriter')
